...
and StructuralOffice status on its dashboard. Version `1.0.0` is the stable desktop
release for the StructuralOffice Home Assistant integration `1.0.0` and provides:
